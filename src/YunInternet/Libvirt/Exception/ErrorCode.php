...
interface ErrorCode
{
    ...
    const DISK_TARGET_DEV_VALUE_NOT_UNIQUE = 20010;

    const INTERFACE_MAC_ADDRESS_NOT_UNIQUE = 20011;

    const FILTER_RESULT_NOT_UNIQUE = 20012;

    const NOT_A_ITEM_CAN_BE_FOUND = 200013;
}